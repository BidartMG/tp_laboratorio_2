...
namespace Navegador
{
    public partial class frmWebBrowser : Form
    {
        ...
        {
            frmHistorial elHistorial = new frmHistorial();
            elHistorial.ShowDialog();
        }
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                descargador.progreso += new Progreso(this.ProgresoDescarga);
                descargador.descarga += new DescargaCompleta(this.FinDescarga);
            ...
            {
                MessageBox.Show(exc.Message,"Ocurrio un error",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
        }
    }
}
